...
public class OrderUserController {
	...
	@PostMapping("/buy/{id}")
	public String buy(@ModelAttribute("order") OrderModel order, @PathVariable("id") Integer id, BindingResult result,
	...
	public String store(@ModelAttribute("order") OrderModel order, HttpServletRequest request, BindingResult result) {
