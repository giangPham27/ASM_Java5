...
<div class=""
	...
	<div class="container p-0 mt-2" style="">
		<div class="">
			<a href="/ASM_Java5/admin/create_order"
						...
						<c:if test="${!empty ls }">
							<c:forEach items="${ ls }" var="o">
								<tr>
									...
									<td><a href="/ASM_Java5/admin/confirm_order/${o.id}"
										class="btn btn-secondary">Xác nhận</a></td>
									<td><a href="/ASM_Java53/admin/cancel_order/${o.id}" class="btn btn-danger">Hủy đơn</a></td>
								</tr>
							</c:forEach>
						</c:if>
					</tbody>
