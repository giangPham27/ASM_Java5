...
<body>
	...
	<div class="menu">
		<ul class="d-flex flex-row-reverse">
			...
			<li><img src="../image/icon/icons8-taxi-mobile-payment-24.png" alt=""><a href="/ASM_Java5/admin/hoadon">Hóa đơn</a></li>
			<li><img src="../image/icon/icons8-check-dollar-24.png" alt=""><a href="/ASM_Java5/admin/doanhthu">Doanh thu</a></li>
		</ul>
	</div>
	...
	<nav class="navbar navbar-expand-lg bg-light">
		<div class="container-fluid layout">
			<div class="ms-5">
				<a class="navbar-brand" href="/ASM_Java5/admin/index_order"> <img
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link active navtext"
							aria-current="page" href="/ASM_Java5/admin/index_user">Người dùng</a></li>
						<div class="tx"> </div>
						<li class="nav-item"><a class="nav-link active navtext"
							aria-current="page" href="/ASM_Java5/admin/index_product">Sản phẩm</a></li>
						<div class="tx"></div>
						<li class="nav-item"><a class="nav-link active navtext"
							aria-current="page" href="/ASM_Java5/admin/index_order">Đơn hàng</a></li>
						<div class="tx">
						</div>
						<li class="nav-item"><a class="nav-link active navtext"
