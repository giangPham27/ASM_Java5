...
<div class="container p-0 mt-2" style="min-height: 460px;">
	<div class="row">
		<c:forEach items="${ ls }" var="pro">
			...
			<a href="/ASM_Java5/product/${pro.id}" style="text-decoration: none; color: #303030;">
				<div class="card" style="width: 14rem;">
					...
					<div class="card-body">
						...
						<a href="/ASM_Java5/buynow/${pro.id}" class="btn btn-outline-secondary form-control mt-2">Mua Ngay</a>
					</div>
				</div>
			</a>
		</div>
