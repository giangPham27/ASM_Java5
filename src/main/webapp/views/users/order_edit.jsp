		...
		<div class="row">
			<div class="col-7">
				...
				<div class="">
					...
					<form:form action="/ASM_Java5/orderupdate_user/${o.id}" modelAttribute="order">
						<div class="mt-2">
					...
					<tbody>
						<c:forEach items="${ lsoddl }" var="od">
							<tr>
								...
								<form:form action="/ASM_Java5/updateorderdetails/${od.id}" method="post" modelAttribute="quantity">
